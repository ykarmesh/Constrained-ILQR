...
def get_vehicle_driving_impedance_acceleration(vehicle_info, vehicle_status, reverse):
    ...
    aerodynamic_drag_force = get_aerodynamic_drag_force(vehicle_info, vehicle_status)
    ...
    deceleration = impedence_force / get_vehicle_mass(vehicle_info)
...
def get_aerodynamic_drag_force(vehicle_info, vehicle_status):
    """
    ...
    if vehicle.info.drag_coefficient:
        default_aerodynamic_drag_coefficient = vehicle.info.drag_coefficient
