...
def add_arguments(parser):
    ...
    parser.add_argument('--w_acc', type=float, default=2.00, help="Acceleration cost")
    ...
    parser.add_argument('--q2_acc', type=float, default=3.00, help="Barrier function q2, acc")
